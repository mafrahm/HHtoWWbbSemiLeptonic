...
value_per_systematic_and_process = {
    ...
    tuple(['rate_scales_V', 'WJets']): 1.038,
    tuple(['rate_scales_V', 'DYJets']): 1.020,
    ...
    tuple(['rate_pdf_qq', 'WJets']): '0.996/1.008',
    tuple(['rate_pdf_qq', 'DYJets']): 1.002,

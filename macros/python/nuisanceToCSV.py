...
for i in range(fpf_s.getSize()):
    ...
    prefit_,prefit_e,postfit_b,postfit_b_up,postfit_b_down,postfit_s,postfit_s_up,postfit_s_down,impact=0,0,0,0,0,0,0,0,0
    ...
    impact = (nuis_x.getError()*fit_s.correlation(name, options.poi)*error_poi)

    ##### checking outputs and writing to csv
    ...
    with open('/nfs/dust/cms/user/frahmmat/CMSSW_10_2_X_v2/CMSSW_10_2_17/src/UHH2/HHtoWWbbSemiLeptonic/data/datacards/output/nuisances.csv', mode='a') as f:
        ...
        f_writer.writerow([name,prefit_,prefit_e,postfit_b,postfit_b_up,postfit_b_down,postfit_s,postfit_s_up,postfit_s_down,impact])

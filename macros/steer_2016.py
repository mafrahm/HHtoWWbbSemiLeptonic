...
systematics = [
    ...
    'scale_TTbar', 'scale_WJets', 'scale_DYJets', 
    'scale_TTV', 'scale_Diboson', 
...
fitDiagnostics = bool(True);


combineInput='combineRateShape_Inclusive_NNbkgweightX8_removeQCD_classes4_TrainOn30_2016.root'
#combineInput='combineRateShape_Inclusive_NNremoveQCD_classes4_TrainOn30_allYears_2016.root'
...
#CombineRunner.CombineChannels(nodes, channels, cardnametag)
#CombineRunner.ExecuteCombineCombination(nodes, channels, fitDiagnostics, cardnametag)
